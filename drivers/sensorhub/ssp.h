...
#define MAX_ACCEL_2G		2047
#define MIN_ACCEL_2G		-2048
#define MAX_ACCEL_4G		4096
#else
/* 16bits */
...
void initialize_gesture_factorytest(struct ssp_data *);
...
void remove_gesture_factorytest(struct ssp_data *);
